...
public class GunData {
    ...
    public static GunRecord m4 = new GunRecord("m4", WeaponCategory.RIFLE, 15, 12, 1000, 250, 240, 30, 1500, 5, 25, 2);
    public static GunRecord mp5 = new GunRecord("mp5", WeaponCategory.SMG, 10, 20, 800, 150, 240, 30, 1000, 8, 20, 2);
    public static GunRecord svd = new GunRecord("svd", WeaponCategory.DMR, 100, 2, 2000, 500, 80, 10, 2500, 2, 100, 5);
    public static GunRecord pkm = new GunRecord("pkm", WeaponCategory.LMG, 12, 16, 1000, 300, 800, 100, 4000, 8, 34, 3);
    public static GunRecord vaporizer = new GunRecord("vaporizer", "pkm", WeaponCategory.LMG, 5, 200, 100, 300, 8000, 2000, 4000, 50, 10, 2);
    ...
    public static class GunRecord {
        ...
        public GunRecord(String name, WeaponCategory category, float damage, float fireRate,
                         ...
                         float bloom, float impact, int penetration) {
            this(name, name, category, damage, fireRate, projectileSpeed, range, ammo,
                    magSize, reloadTime, bloom, impact, penetration);
        }
